<script lang="ts">
	...
	import Sidebar from "$lib/Navigation/NewSidebar.svelte";
	...
	// import { isNavTransparent } from "../../routes/stores";
	...
	export let isNavTransparent = writable(false)
...
<div style:display="content" style:z-index="0">
	<slot></slot>
</div>
<style lang="scss">
