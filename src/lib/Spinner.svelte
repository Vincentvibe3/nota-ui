...
<div 
	...
	{:else}
		<div 
			...
			<svg class="checkmarkSvg" xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={checkMarkColor} viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><polyline points="216 72 104 184 48 128" fill="none" stroke={checkMarkColor} stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></polyline></svg>
		</div>
	{/if}
</div>
...
<style>
	...
	.customCheckmark {
		...
		background-color: var(--spinnerLoadedColor, #99003b);
		border-radius: 100vw;
		animation-name: fillAnimation;
