...
<div 
	...
	<div 
		...
		<svg class="checkmarkSvg" xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="var(--spinnerIcon, #ffffff)" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><polyline points="216 72 104 184 48 128" fill="none" stroke="var(--spinnerIcon, #ffffff)" stroke-linecap="round" stroke-linejoin="round" stroke-width="24"></polyline></svg>
	</div>
	<div 
		style="width: {size}; height:{size};" 
		class="custom error" class:show={status=="error"}>
		<!-- check icon from phosphor icons -->
		<svg class="errorSvg" xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="var(--spinnerIcon, #ffffff)" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><line x1="200" y1="56" x2="56" y2="200" stroke="var(--spinnerIcon, #ffffff)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="200" y1="200" x2="56" y2="56" stroke="var(--spinnerIcon, #ffffff)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg>
	</div>
</div>
...
<style>
	...
	.custom.checkmark{
		background-color: var(--spinnerBgComplete, #99003b);
	}

	.custom.error{
		background-color: var(--spinnerBgError, #99003b);
	}
