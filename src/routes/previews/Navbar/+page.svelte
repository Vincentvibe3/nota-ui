...
{#if icon}
    <Navbar bind:alwaysOpaque={opaque} style="top:0px;left:0px;">
...
{/if}
<div class="controls">
    <div class="strictControl iconToggle">
        <Checkbox bind:checked={icon}></Checkbox>
        <p>
            Toggle icon
        </p>
    </div>
    <div class="strictControl iconToggle">
        <Checkbox bind:checked={opaque}></Checkbox>
        <p>
            Toggle opacity
        </p>
    </div>
